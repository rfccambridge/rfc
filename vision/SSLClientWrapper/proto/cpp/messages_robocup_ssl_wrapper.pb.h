...
inline const ::SSL_DetectionFrame& SSL_WrapperPacket::detection() const {
  const ::SSL_WrapperPacket &defaultInstance = ::SSL_WrapperPacket::default_instance();	
  return detection_ != NULL ? *detection_ : *defaultInstance.detection_;
...
inline const ::SSL_GeometryData& SSL_WrapperPacket::geometry() const {
	const ::SSL_WrapperPacket &defaultInstance = ::SSL_WrapperPacket::default_instance();	
	return geometry_ != NULL ? *geometry_ : *defaultInstance.geometry_;
