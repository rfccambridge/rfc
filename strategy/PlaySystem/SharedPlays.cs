    ...
    static class SharedPlays
    {
        ...
        public static void SupportRobot_1(GameState state)
        {
            ...
            if (ballinrange)
            {
                ...
                Vector2 theirgoalpositivequad = LineCircleIntersectionDeprecated.Intersection(new Line(Field.theirgoal, Field.topCenter), theirgoalcircle, 1);
                Vector2 theirgoalnegativequad = LineCircleIntersectionDeprecated.Intersection(new Line(Field.theirgoal, Field.bottomCenter), theirgoalcircle, 1);
            ...
            else
            {
                ...
                Vector2 balldestination = LineCircleIntersectionDeprecated.Intersection(new Line(ballpoint, Field.theirgoal), new Circle(ballpoint, 1), 1);
