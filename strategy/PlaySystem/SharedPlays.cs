...
namespace Robocup.PlaySystem
{
    ...
    static class SharedPlays
    {
        ...
        public static void TwoManWall_2(GameState state, double perimeter)
        {
            ...
            Vector2 point1 = LineCircleIntersectionDeprecated.Intersection(ballgoalline, goalperim, -1);
        ...
        {
            //TODO(davidwu): Can GetBall() return null here?
            Vector2 ballpoint = state.Predictor.GetBall().Position;
            Line ballgoalline = new Line(ballpoint, Constants.FieldPts.OUR_GOAL);
            Circle goalperim = new Circle(Constants.FieldPts.OUR_GOAL, distance);
            Vector2 defenderpoint = LineCircleIntersectionDeprecated.Intersection(ballgoalline, goalperim, -1);
        ...
        public static void SupportRobot_1(GameState state)
        {
            ...
            if (ballinrange)
            {
                ...
                Vector2 theirgoalpositivequad = LineCircleIntersectionDeprecated.Intersection(new Line(Constants.FieldPts.THEIR_GOAL, Constants.FieldPts.TOP), theirgoalcircle, 1);
                Vector2 theirgoalnegativequad = LineCircleIntersectionDeprecated.Intersection(new Line(Constants.FieldPts.THEIR_GOAL, Constants.FieldPts.BOTTOM), theirgoalcircle, 1);
            ...
            else
            {
                ...
                Vector2 balldestination = LineCircleIntersectionDeprecated.Intersection(new Line(ballpoint, Constants.FieldPts.THEIR_GOAL), new Circle(ballpoint, 1), 1);
        ...
        public static void GuardBall_1_2_3(GameState state, int numRobots)
        {
            ...
            Line ballgoalline = new Line(ballpoint, Constants.FieldPts.OUR_GOAL);
            Vector2 wall1pt = LineCircleIntersectionDeprecated.Intersection(ballgoalline, ballcircle, 1);
